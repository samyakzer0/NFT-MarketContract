...
uint256 listingPrice = 0.0020 ether;
    ...
    constructor() ERC721("NFT Hub Token" , "MYNFT" ){
    ...
    function createMarketItem(uint256 tokenId, uint256 price) private  payable {
    ...
    function createMarketSale(uint256 tokenId) public payable {
        ...
        require(idMarketItem[tokenId].owner != msg.sender, "You Cannot Buy Your Own Token");
